...
class Vertex extends EventEmitter {
  ...
  constructor(vertex, name, config = {}) {
    ...
    if (!this.name) this.name = this.config.name || createWord(11, {finish: true});
...
Object.defineProperty(Vertex, 'Distributor', {value: Distributor, enumerable: true});
