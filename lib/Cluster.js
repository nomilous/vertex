...
class Cluster extends EventEmitter {
  ...
  getMaster() {
    return new Promise(resolve => {
      if (!this._masterName) return console.log('WAIT FOR MASTER'); // TODO...
      if (!this.members[this._masterName]) return console.log('WAIT FOR MASTER'); // TODO...
    ...
    return new Promise((resolve, reject) => {
      ...
      let onJoin1Reply = ({join1}) => {
        if (join1.me) {
          ...
          this.log.info('master at %s', this._masterName);
        ...
        // this.log.info('master at ', this._masterName);
      };
